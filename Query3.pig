...
A = load '/home/acadgild/MovieDataset/movies.csv' using PigStorage(',') as (movieId:long, title:chararray, genre:bytearray);
...
A1 = load '/home/acadgild/MovieDataset/ratings.csv' using PigStorage(',') as (userId:int, movieId:long, rating:double);
